...
# spike Test
~/ycsb-0.17.0/bin/ycsb.sh run mongodb -s -P ~/ycsb-0.17.0/workloads/workloadb -p operationcount=20000 -p target=10000 -p threadcount=500 -p mongodb.url="mongodb://user-db:27017/users" -p mongodb.upsert=true

# stress test
~/ycsb-0.17.0/bin/ycsb.sh run mongodb -s -P ~/ycsb-0.17.0/workloads/workloadb -p operationcount=1000000 -p target=2000 -p threadcount=500 -p mongodb.url="mongodb://user-db:27017/users" -p mongodb.collection=usertable -p mongodb.upsert=true
...
kubectl exec -it user-db-c6f98b7d9-qck9q -- bash
